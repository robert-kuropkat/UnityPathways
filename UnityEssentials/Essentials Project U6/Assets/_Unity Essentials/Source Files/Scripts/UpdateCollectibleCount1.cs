...
public class UpdateCollectibleCount1 : MonoBehaviour
{
    ...
    private void UpdateCollectibleDisplay()
    {
        ...
        {
            totalRunTime = Time.timeSinceLevelLoad.ToString("F1");
        }

        // Update the collectible count display
        collectibleText.text = $"Dirt spots remaining: {totalCollectibles} <br> Total runtime: {totalRunTime} seconds ";
